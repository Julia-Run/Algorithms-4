...
public class Exercise31_StrongComponent {
    // have no idea what this is trying to do
    ...
    public List<Set<Integer>> getAllStrongComponents(Digraph digraph) {
        ...
        for (int vertex = 0; vertex < digraph.V(); vertex++) {
            ...
            Set<Integer> strongComponent = getStrongComponent(digraph, vertex,
                                                              verticesAlreadyInAnotherSCC);
    ...
    // O (V + E)
    public Set<Integer> getStrongComponent(Digraph digraph, int sourceVertex,
                                           Set<Integer> verticesAlreadyInAnotherSCC) {
        ...
        for (int vertexReachableFromSource : verticesReachableFromSource) {
            ...
            boolean canReachStrongComponent = dfsToReachStrongComponent(digraph, visited,
                                                                        vertexReachableFromSource,
                                                                        strongComponent,
                                                                        verticesAlreadyInAnotherSCC,
                                                                        verticesThatCannotReachSource);
    ...
    private boolean dfsToReachStrongComponent(Digraph digraph, Set<Integer> visited, int vertex,
                                              Set<Integer> currentStrongComponent,
                                              Set<Integer> verticesAlreadyInAnotherSCC,
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> strongComponent1 = strongComponent.getStrongComponent(digraph1, 2,
                                                                           new HashSet<>());
        ...
        Set<Integer> strongComponent2 = strongComponent.getStrongComponent(digraph2, 2,
                                                                           new HashSet<>());
        ...
        Set<Integer> strongComponent3 = strongComponent.getStrongComponent(digraphWorstCase, 0,
                                                                           new HashSet<>());
        ...
        List<Set<Integer>> strongComponents3 = strongComponent.getAllStrongComponents(
                digraphWorstCase);
