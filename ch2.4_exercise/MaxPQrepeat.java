...
public class MaxPQrepeat<Item extends Comparable<Item>> {  /* 继承*/
    /* variables*/
    private Item[] a;
    private int n = 0;

    /* constructor*/
    public MaxPQrepeat(int maxsize) {
        a = (Item[]) new Comparable[maxsize + 1];  /* ******************************/
    }

    public MaxPQrepeat(Integer[] arr, int x) {
        n = arr.length;
    ...
    public static void main(String[] args) {
        ...
        MaxPQrepeat d = new MaxPQrepeat(c, 10);  /* 10 refers to extra spaces*/
        d.insert(1000);
        d.insert(2000);
