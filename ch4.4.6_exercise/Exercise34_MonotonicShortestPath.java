...
public class Exercise34_MonotonicShortestPath {
    ...
    public class DijkstraMonotonicSP {
        ...
        public DijkstraMonotonicSP(EdgeWeightedDigraph edgeWeightedDigraph, int source) {
            distToMonotonicAscending = new double[edgeWeightedDigraph.V()];
            distToMonotonicDescending = new double[edgeWeightedDigraph.V()];
            distTo = new double[edgeWeightedDigraph.V()];

            edgeToMonotonicAscending = new DirectedEdge[edgeWeightedDigraph.V()];
            edgeToMonotonicDescending = new DirectedEdge[edgeWeightedDigraph.V()];
        ...
        private void relaxAllEdgesInSpecificOrder(EdgeWeightedDigraph edgeWeightedDigraph, int source,
            ...
            for (int vertex = 0; vertex < edgeWeightedDigraph.V(); vertex++) {
                ...
                int edgeIndex = 0;
                for (DirectedEdge edge : edgeWeightedDigraph.adj(vertex)) {
